# 📖 EBook-RS Developer Wiki (v0.13.0)
...
`ebook-rs` (v0.13.0) is designed for:
...
2. **Multi-Format Parity**: EPUB 2, EPUB 3, Amazon KFX (KF10), MOBI (PalmDOC LZ77), AZW3 (KF8), FB2, KEPUB, LIT, CBZ (Comic Book ZIP), PDF, ODT, TXT, and MD.
